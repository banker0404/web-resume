export const ProjectsData = [
    {
        ...
        ProjectDescription: [
            "Built a machine learning model to recommend music based on the current song the user is listening to bases on the genre of the song and the varios numerical attributes of the song like valence, acousticness, danceability, etc.",
